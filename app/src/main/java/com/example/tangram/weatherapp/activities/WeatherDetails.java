...
import com.example.tangram.weatherapp.utils.IconProvider;
...
public class WeatherDetails extends AppCompatActivity {
    ...
    private void setCardData() {
        ...
        textViewCurrentTemp.setText((int) cityWeather.getWeeklyWeather().get(0).getMain().getTemp()+"°");
        textViewMaxTemp.setText((int) cityWeather.getWeeklyWeather().get(0).getMain().getTemp_max()+"°");
        textViewMinTemp.setText((int) cityWeather.getWeeklyWeather().get(0).getMain().getTemp_min()+"°");

        textViewHumidity.setText((int) cityWeather.getWeeklyWeather().get(0).getMain().getHumidity() +"%");
        textViewWind.setText((int) cityWeather.getWeeklyWeather().get(0).getWind().getSpeed()+" m/s");
        textViewCloudiness.setText((int) cityWeather.getWeeklyWeather().get(0).getClouds().getAll()+"%");
        textViewPressure.setText((int) cityWeather.getWeeklyWeather().get(0).getMain().getPressure()+" hPa");
        ...
        for (int i = 1; i < cityWeather.getWeeklyWeather().size(); i++) {
            ...
            switch (i){
                ...
                case 1:
                    ...
                    textViewMaxTempDay1.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_max()+"°C");
                    textViewMinTempDay1.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_min()+"°C");
                    break;
                case 2:
                    textViewDay2.setText(day);
                    weatherWeekDescription = cityWeather.getWeeklyWeather().get(i).getWeatherDetails().get(0).getShotDescription();
                    Picasso.with(this).load(IconProvider.getImageIcon(weatherWeekDescription)).into(imageViewDay2);
                    textViewMaxTempDay2.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_max()+"°C");
                    textViewMinTempDay2.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_min()+"°C");
                    break;
                case 3:
                    textViewDay3.setText(day);
                    weatherWeekDescription = cityWeather.getWeeklyWeather().get(i).getWeatherDetails().get(0).getShotDescription();
                    Picasso.with(this).load(IconProvider.getImageIcon(weatherWeekDescription)).into(imageViewDay3);
                    textViewMaxTempDay3.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_max()+"°C");
                    textViewMinTempDay3.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_min()+"°C");
                    break;
                case 4:
                    textViewDay4.setText(day);
                    weatherWeekDescription = cityWeather.getWeeklyWeather().get(i).getWeatherDetails().get(0).getShotDescription();
                    Picasso.with(this).load(IconProvider.getImageIcon(weatherWeekDescription)).into(imageViewDay4);
                    textViewMaxTempDay4.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_max()+"°C");
                    textViewMinTempDay4.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_min()+"°C");
                    break;
                case 5:
                    textViewDay5.setText(day);
                    weatherWeekDescription = cityWeather.getWeeklyWeather().get(i).getWeatherDetails().get(0).getShotDescription();
                    Picasso.with(this).load(IconProvider.getImageIcon(weatherWeekDescription)).into(imageViewDay5);
                    textViewMaxTempDay5.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_max()+"°C");
                    textViewMinTempDay5.setText((int) cityWeather.getWeeklyWeather().get(i).getMain().getTemp_min()+"°C");
                    break;
                default:
                    break;
            }
