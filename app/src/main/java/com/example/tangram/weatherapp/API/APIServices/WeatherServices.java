package com.example.tangram.weatherapp.API.APIServices;
...
//    Call<CityWeather> getWeatherCity (@Query("q") String city, @Query("APPID")String key, @Query("units") String units ,@Query("cnt") int days);
    ...
    @GET("forecast/")
    Call<CityWeather> getWeatherCity (@Query("q") String city, @Query("units") String units,  @Query("APPID")String key);
}
